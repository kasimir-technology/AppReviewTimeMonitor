...
public class AppReviewTimeMonitorStyleKit : NSObject {
    ...
    public class func drawCombinedStatusBarImage(iosDayLabel iosDayLabel: String = "99", osxDayLabel: String = "99") {
        ...
        //// Rectangle Drawing
        let rectanglePath = NSBezierPath(roundedRect: NSMakeRect(1, 5, 39.5, 13), xRadius: 3, yRadius: 3)
        NSColor.blackColor().setStroke()
        rectanglePath.lineWidth = 1
        rectanglePath.stroke()
        ...
        //// Text 2 Drawing
        let text2Rect = NSMakeRect(22, 6, 16, 11)
        ...
        //// Bezier Drawing
        let bezierPath = NSBezierPath()
        bezierPath.moveToPoint(NSMakePoint(20.5, 18.5))
        bezierPath.lineToPoint(NSMakePoint(20.5, 5.5))
        NSColor.blackColor().setStroke()
